                ...
                <div className='flex flex-col gap-y-3 mb-5'>
                    <form action="">
                        <div className='flex flex-col gap-y-3 mb-3'>
                            <input {...register("otp")} type="text" placeholder='Otp' className='focus:outline-none w-[300px] px-3 py-3 outline-none border-[1px] border-[#272829] placeholder:text-[#272829] placeholder:font-semibold '/>
