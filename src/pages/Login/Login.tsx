      ...
      <div>
        <div className='w-[300px] border-b-[1px] border-[#272829] pb-6'>
            ...
            <div className='flex gap-x-[1px]'>
              ...
              <Link to="/forgetpassword" className='font-semibold underline text-[#8614BC]'>Quên mật khẩu</Link>
            </div>
        </div>
        <div className='flex gap-x-[1px] justify-center py-5'>
          <span>Bạn chưa có tài khoản?</span>
          <Link to="" className='font-semibold underline text-[#8614BC]'>Đăng ký</Link>
        </div>
      </div>
    </div>
  )
