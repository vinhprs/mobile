...
const TitleResultExam = () => {
  return (
    <div className="">
      ...
      <div className="px-[16px] py-[18px] border-[2px] border-[#FF6636] rounded-lg">
        <div className="flex items-center gap-x-4 h-full">
          <div className="flex flex-col gap-1 items-center px-[16px]">
            ...
            <h1 className="text-[18px] text-[#FF6636] font-medium">1.5/10</h1>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 flex-1">
            <div className="flex items-center gap-x-[10px]">
              ...
              <span className="">
                Số câu đã làm:{" "}
                <span className="text-[#FF6636] font-semibold">10/10</span>
              </span>
            </div>
            <div className="flex items-center gap-x-[10px]">
      ...
      <div className="flex justify-center gap-x-[10px] mt-3">
